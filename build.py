...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.hflip.js')
	...
	f = os.path.join(cwd,'Classes','ComHflipModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.hflip.js']
